...
#data 2
def load_data3():
	fn = '/home/delores/Desktop/fMRI/data/ttest feature.mat'
	mat = scipy.io.loadmat(fn)
	FA = mat['fa2']
	ALFF = mat['alff2']
	GM = mat['gm2']
...
def print_means(results,name):
	...
	print name,"\tA:%5.5f\tB:%5.5f\tC:%5.5f\tD:%5.5f\tE:%5.5f\tF:%5.5f\tG:%5.5f\tH:%5.5f" %(results[0],results[1],results[2],results[3],results[4],results[5],results[6],results[7])

def means_save(results,name):
	algorithms = ['svm linear','svm rbf','knn','gaussianNB','bernoulliBN','multinomialNB','logistic','forests']
	means = [results[0],results[1],results[2],results[3],results[4],results[5],results[6],results[7]]
	#print "\tSVM Linear\tSVM RBF\tKNN\tGaussian\tBernoulli\tmultinomial\t\tLogistic Reg.\t\tRandom Forest"
	return name + "\n\tA:%5.5f\tB:%5.5f\tC:%5.5f\tD:%5.5f\tE:%5.5f\tF:%5.5f\tG:%5.5f\tH:%5.5f\n" %(results[0],results[1],results[2],results[3],results[4],results[5],results[6],results[7])
